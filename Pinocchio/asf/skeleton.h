...
namespace asf {
	...
	class Skeleton 
	{
		public: 
			...
			const std::vector<Bone*> & getBonesFat() {return bonesFat;}
			const std::vector<Bone*> & getBonesFeet() {return bonesFeet;}
			const std::vector<std::tuple<Bone*, Bone*>> & getBonePairs() {return bonePairs;}
		...
		protected:
			...
			void initAbsolutePos(Bone * parent);
			void normalize();
			...
			std::vector<Bone *> bonesFat;
			std::vector<Bone *> bonesFeet;
			std::vector<std::tuple<Bone*, Bone*>> bonePairs;
